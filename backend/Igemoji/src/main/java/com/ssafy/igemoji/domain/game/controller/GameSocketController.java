...
import com.ssafy.igemoji.domain.game.service.GameTimerService;
...
//        gameSocketService.initGame(requestDto);
        ...
        // 시간 카운트
        gameTimerService.startGameScheduler(requestDto.getRoomId());
        gameTimerService.sendRemainingTime();
